      ...
      const response = await fetch("/api/ai/generate-images", {
        ...
        body: JSON.stringify({
          events: [{ 
            ...
            omitLikenessReference: event.omitLikenessReference === true,
          }],
          imageStyle,
          themeColor,
          imageReferences,
    ...
    try {
      ...
      const response = await fetch("/api/ai/generate-images?stream=true", {
        ...
        body: JSON.stringify({
          ...
          omitLikenessReferences: selectedEventsList.map((e) => e.omitLikenessReference === true),
          imageStyle,
          themeColor,
          imageReferences,
          includesPeople,
            ...
            try {
              const retryResponse = await fetch("/api/ai/generate-images", {
                ...
                body: JSON.stringify({
                  ...
                  omitLikenessReferences: remainingFailedEvents.map((e) => e.omitLikenessReference === true),
                  imageStyle,
                  themeColor,
                  imageReferences,
                  includesPeople,
