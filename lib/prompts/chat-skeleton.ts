...
- **Thesis:** Infer **one** clear through-line from the name + description (not every parallel subtopic). Broad policy-era topics read better with a single interpretive spine (e.g. how rules shifted from A to B over the period) unless the user asked for exhaustive coverage.
