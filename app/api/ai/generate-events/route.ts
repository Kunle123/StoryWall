...
- If the timespan is 2020-2025, include events from multiple years (e.g., 2020, 2021, 2022, 2023, 2024, 2025) if significant events exist in those years
- Prioritize including at least one event from each year in the timespan when significant events exist
...
- Example: For a timeline "2020 to 2025", if you find 10 events, distribute them across multiple years (e.g., 2-3 events from 2020, 1-2 from 2021, 2 from 2022, etc.) rather than putting all 10 events in 2020
