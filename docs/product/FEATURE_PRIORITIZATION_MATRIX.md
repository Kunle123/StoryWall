...
| 36 | **Legal / compliance pass** | Terms, privacy, age, content policies appropriate for beta — **UK** law (UK GDPR, DPA 2018, PECR, ICO). | 4 | 2 | 3 | Prioritised | [#12](https://github.com/Kunle123/StoryWall/issues/12) · [`LEGAL_COMPLIANCE_BETA.md`](./LEGAL_COMPLIANCE_BETA.md) |
...
36,"Legal / compliance pass","Terms, privacy, age, content policies for beta — UK law (UK GDPR, DPA 2018, PECR, ICO).",4,2,3,"Prioritised","#12"
