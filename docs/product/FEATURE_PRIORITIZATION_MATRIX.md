...
| 26 | **Private beta gates checklist** | Launch checklist before private beta (quality, legal, support)—living doc, not automated CI. | 4 | 4 | 2 | Prioritised | [#14](https://github.com/Kunle123/StoryWall/issues/14) · [`LAUNCH_GATES_CHECKLIST.md`](./LAUNCH_GATES_CHECKLIST.md) |
